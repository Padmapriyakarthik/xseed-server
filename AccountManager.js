    ...
    try {
        ...
        if(users){
            ...
            if(user){
                ...
                html: '<p>Hai '+req.body.name+' !</p> <p>We are delighted to have you on board</p>Click <a href="https://xseed-server.herokuapp.com/activate-user/' + token + '">here</a> to activate your account'
